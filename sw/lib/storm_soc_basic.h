...
#define ROM_BASE        (*(REG32 (0x00010000)))
#define ROM_SIZE        8*1024

/* De-Cached IO Area */
#define IO_AREA_BEGIN   (*(REG32 (0x01000000)))
...
/* UART 0 - miniUART */
#define UART0_BASE      (*(REG32 (0xFFFF0100)))
...
/* System Timer 0 */
#define STME0_BASE      (*(REG32 (0xFFFF0200)))
#define STME0_SIZE      4*4
#define STME0_CNT       (*(REG32 (0xFFFF0200)))
#define STME0_VAL       (*(REG32 (0xFFFF0204)))
#define STME0_CONF      (*(REG32 (0xFFFF0208)))
#define STME0_SCRT      (*(REG32 (0xFFFF020C)))

/* SPI Controller 0 */
#define SPI0_BASE       (*(REG32 (0xFFFF0300)))
#define SPI0_SIZE       8*4
#define SPI0_CONF       (*(REG32 (0xFFFF0300)))
#define SPI0_PRSC       (*(REG32 (0xFFFF0304)))
#define SPI0_SCSR       (*(REG32 (0xFFFF0308)))
// unused location      (*(REG32 (0xFFFF030C)))
#define SPI0_DAT0       (*(REG32 (0xFFFF0310)))
#define SPI0_DAT1       (*(REG32 (0xFFFF0314)))
#define SPI0_DAT2       (*(REG32 (0xFFFF0318)))
#define SPI0_DAT3       (*(REG32 (0xFFFF031C)))
...
/* I²C Controller 0 */
#define I2C0_BASE       (*(REG32 (0xFFFF0400)))
#define I2C0_SIZE       8*4
#define I2C0_CMD        (*(REG32 (0xFFFF0400)))
#define I2C0_STAT       (*(REG32 (0xFFFF0400)))
// unused location      (*(REG32 (0xFFFF0404)))
// unused location      (*(REG32 (0xFFFF0408)))
// unused location      (*(REG32 (0xFFFF040C)))
#define I2C0_PRLO       (*(REG32 (0xFFFF0410)))
#define I2C0_PRHI       (*(REG32 (0xFFFF0414)))
#define I2C0_CTRL       (*(REG32 (0xFFFF0418)))
#define I2C0_DATA       (*(REG32 (0xFFFF041C)))
